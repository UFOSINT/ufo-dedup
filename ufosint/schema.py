...
Canonical location for schema creation logic, migrated from the
root-level create_schema.py script.
"""
import os
import sqlite3
...
def create_schema(db_path=None):
    """Create the unified schema at the given path (or Config default)."""
    if db_path is None:

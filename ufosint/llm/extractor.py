...
Canonical location for LLM field extraction logic, migrated from
the root-level run_enrich.py script.
"""
...
OUTPUT_DIR = os.path.join(Config.project_root(), "data", "output")
EXTRACT_CSV = Config.cache_path("llm_field_extractions.csv")
LOG_FILE = os.path.join(Config.project_root(), "enrich_extract.log")

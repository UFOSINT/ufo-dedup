...
Canonical location for sentiment batch processing, migrated from the
root-level sentiment.py script. (NOT the same as ufosint/processors/sentiment.py
which handles derived sentiment fields during analysis.)
"""
import os
import sqlite3
import sys
...
def run_sentiment(db_path=None):
...
def reset_sentiment(db_path=None):

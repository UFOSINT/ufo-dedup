...
Canonical location for NUFORC enrichment logic, migrated from the
root-level enrich.py script.
"""
import json
import os
import re
...
def run_enrichment(db_path=None):
    """Run NUFORC enrichment from UFOCAT sidecar data."""
    if db_path is None:
